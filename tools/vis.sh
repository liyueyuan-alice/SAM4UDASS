...
# python vis_mask.py \
# --mask_folder "/media/ywh/1/yanweihao/projects/segmentation/segment-anything/outputs/cityscapes/train_debug/mask" \
# --image_folder "/media/ywh/1/yanweihao/projects/segmentation/segment-anything/outputs/cityscapes/train_debug/img" \
# --output_folder "/media/ywh/1/yanweihao/projects/segmentation/segment-anything/outputs/cityscapes/train_debug/mix" \
# --mix_ratio 0.5 \
# --mask_suffix ".png" \
# --img_suffix ".png" \
